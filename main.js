...
// localStorage.clear(); // Можно создать кнопку сброса и сбрасывать. Пока сбрасывается при обновлении браузера.
...
function moveEnemy() {
    ...
    enemy.forEach(function (item) {
        ...
        if (carRect.top + 2 <= enemyRect.bottom && carRect.right + 3 >= enemyRect.left && carRect.left + 3 <= enemyRect.right && carRect.bottom + 4 >= enemyRect.top) {
            setting.start = false;
            audio.remove();
            console.warn('ДТП');
            crash.play();
